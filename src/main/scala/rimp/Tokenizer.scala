package rimp
/**
 * A class that includes implementation of functions to convert
 * tokens generated by lexer to Token objects for easier analysis
 * and filtering. The code used in this class is developed from the
 * source code given in Compiler and Formal Languages Module at
 * King's College London led by Dr. Christian Urban.
 */
class Tokenizer extends Lexer {
  ...
  /**
   * This partial function takes a lexed pair of a lexeme and
   * a corresponding token string, and returns a corresponding Token object.
   */
